...
- `p` pomodoro
- `o` log dir
- `z` focus mode (maximize the focused panel)
- `\` toggle chrome (hide panel borders/titles + status bar for distraction-free focus)
...
- `PgUp/PgDn` jump
- `e` edit source entry
- `z` toggle reading mode (distraction-free fullscreen, centered prose)
- `Esc` close
